...
; add for Revo Mirror Setup

;//RS5StartInstallation=开始安装
RS5LicenseDescription=我已阅读并同意
RS5UserLicenseDetail=用户许可协议
RS5SetupSettings=安装设置
RS5SetupPath=安装路径：
RS5DirChangeEnableTips=软件已经安装，不允许更换安装路径。
RS5AppReinstallTips=软件已安装，是否覆盖现有的版本？
RS5AppStartupFailedTips=启动应用程序失败！
RS5AppSetupTitle=Revo Mirror 应用安装
RS5ExitSetupTips=您确定要退出当前的安装吗？
RS5AppRunningInstallTips=应用程序正在运行，请退出应用程序后再重试！
RS5DiskSpaceWarning=没有足够的磁盘空间
RS5Add=和
RS5PrivacyPolicy=隐私政策

RS5SetupImageSuffix=_cn