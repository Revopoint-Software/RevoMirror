...
RS5LicenseDescription=I have read and agree to the
RS5UserLicenseDetail=User Agreement
RS5SetupSettings=Settings
RS5SetupPath=Installation path:
RS5DirChangeEnableTips=The application has already been installed and cannot be installed to a different path.
RS5AppReinstallTips=The application is already installed. Do you want to overwrite the existing version?
RS5AppStartupFailedTips=Failed to start the application!
RS5AppSetupTitle=Installation of Revo Mirror
RS5ExitSetupTips=Are you sure you want to exit the current installation?
RS5AppRunningInstallTips=The application is running, please exit the application and try again!
RS5DiskSpaceWarning=Not Enough Disk Space
RS5Add=And
RS5PrivacyPolicy=Privacy Policy

RS5SetupImageSuffix=_en