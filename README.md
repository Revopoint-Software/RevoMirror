<div align="center">
  ...
  <h1 align="center">RevoMirror-PC</h1>
  <h4 align="center">Cross-platform remote screen mirroring & PC remote control over LAN.</h4>
</div>

<div align="center">
  <a href="https://github.com/Revopoint-Software/RevoMirror-PC/stargazers"><img src="https://img.shields.io/github/stars/Revopoint-Software/RevoMirror-PC.svg?logo=github&style=for-the-badge" alt="GitHub stars"></a>
  <a href="https://github.com/Revopoint-Software/RevoMirror-PC/releases/latest"><img src="https://img.shields.io/github/downloads/Revopoint-Software/RevoMirror-PC/total.svg?style=for-the-badge&logo=github" alt="GitHub Releases"></a>
  <a href="https://github.com/Revopoint-Software/RevoMirror-PC/actions"><img src="https://img.shields.io/github/actions/workflow/status/Revopoint-Software/RevoMirror-PC/ci.yml.svg?branch=main&label=CI%20build&logo=github&style=for-the-badge" alt="CI"></a>
  <a href="https://github.com/Revopoint-Software/RevoMirror-PC/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Revopoint-Software/RevoMirror-PC.svg?style=for-the-badge" alt="License"></a>
</div>
...
**RevoMirror-PC** is a cross-platform remote screen mirroring and remote control solution
...
By integrating Sunshine's hardware-accelerated encoding and capture pipeline, RevoMirror-PC
delivers a smooth, responsive remote desktop experience across devices.

> **Note:** RevoMirror-PC is a derivative work based on Sunshine. The core streaming engine
> is provided by Sunshine, while the RevoMirror-PC application (located in the `tools`
...
RevoMirror-PC is integrated into the Sunshine source tree under the `tools/RevoMirror`
...
On top of this, RevoMirror-PC implements the mirroring workflow and bidirectional
...
RevoMirror-PC inherits the encoding and screen capture capabilities of Sunshine.
...
<table>
    ...
    <tr><td>AMF</td><td>AMD</td><td>➖</td><td>✅</td></tr>
    <tr><td>NVENC</td><td>NVIDIA</td><td>➖</td><td>✅</td></tr>
    <tr><td>QuickSync</td><td>Intel</td><td>➖</td><td>✅</td></tr>
    <tr><td>Video Toolbox</td><td>Apple / Intel</td><td>✅</td><td>➖</td></tr>
    <tr><td>Software</td><td>Any</td><td>✅</td><td>✅</td></tr>
</table>
...
<table>
    ...
    <tr><td>DXGI Desktop Duplication</td><td>➖</td><td>✅</td></tr>
    <tr><td>Windows.Graphics.Capture</td><td>➖</td><td>✅</td></tr>
    <tr><td>ScreenCaptureKit</td><td>✅</td><td>➖</td></tr>
    <tr><td>KMS/DRM</td><td>➖</td><td>➖</td></tr>
    <tr><td>X11</td><td>➖</td><td>➖</td></tr>
    <tr><td>Wayland (wlroots)</td><td>➖</td><td>➖</td></tr>
    <tr><td>KWin Screencast</td><td>➖</td><td>➖</td></tr>
</table>
...
<table>
    ...
    <tr>
        <td>Intel: Skylake or newer with QuickSync (Windows);</td>
    </tr>
    <tr>
...
> [Sunshine documentation](https://docs.lizardbyte.dev/projects/sunshine), as RevoMirror-PC
...
2. Install and run RevoMirror-PC on the host PC.
3. Install the RevoMirror-PC client on your device (Windows / macOS).
...
RevoMirror-PC is licensed under the **GNU General Public License v3.0 (GPL-3.0)**.
...
In compliance with the terms of the GPL, RevoMirror-PC is distributed under the same license.

See the [LICENSE](./LICENSE) file for the full license text.

## 🙏 Acknowledgements & Credits

RevoMirror-PC is built upon the excellent work of the following open-source project:
